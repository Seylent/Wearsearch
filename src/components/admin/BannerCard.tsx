  ...
  return (
    <div className="bg-card/30 text-foreground rounded-xl overflow-hidden border border-border/50 backdrop-blur-sm hover:bg-card/40 transition-colors">
      <div className="flex flex-col md:flex-row">
        {/* Image Preview */}
        <div className="relative w-full md:w-48 h-28 md:h-40 bg-gray-100 shrink-0">
          <Image
        ...
        <div className="flex-1 p-4 flex flex-col">
          ...
          {/* Stats */}
          <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4 text-[11px] sm:text-xs md:text-sm text-muted-foreground mb-3">
          ...
          <div className="mt-auto flex flex-wrap gap-2">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 text-xs sm:text-sm bg-white/5 text-foreground rounded-lg hover:bg-white/10 transition-colors border border-white/10"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 text-xs sm:text-sm bg-red-500/10 text-red-300 rounded-lg hover:bg-red-500/15 transition-colors border border-red-500/20"
            >
