  ...
  <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none" aria-hidden="true">
    ...
    <div
      ...
      style={{
        ...
        boxShadow:
          '0 0 80px hsl(var(--foreground) / 0.06), inset 0 0 60px hsl(var(--foreground) / 0.04)',
      }}
    />
    <div
      ...
      style={{
        ...
        boxShadow: '0 0 50px hsl(var(--foreground) / 0.04)',
      }}
    />
    <div
      ...
      style={{
        borderColor: 'hsl(var(--foreground) / 0.08)',
        boxShadow:
          '0 0 70px hsl(var(--foreground) / 0.05), inset 0 0 40px hsl(var(--foreground) / 0.03)',
      }}
    />
  </div>
);
