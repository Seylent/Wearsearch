          ...
          <div className="prose prose-invert prose-zinc max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-3 text-zinc-300">
                ...
                <p className="leading-relaxed">{t('privacy.section6.p3')}</p>
                <p className="leading-relaxed italic">{t('privacy.section6.browserSettings')}</p>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-3 text-zinc-300">
                ...
                <p className="leading-relaxed">{t('privacy.section9.p2')}</p>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-3 text-zinc-300">
                ...
                <p className="leading-relaxed italic">{t('privacy.section10.note')}</p>
              </div>
            </section>
