    ...
    <div className="min-h-screen text-foreground">
      <main className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-16 pt-24 sm:pt-28 pb-16">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-border/50 px-4 py-2 text-sm">
        ...
        <div className="mb-16">
          ...
          {(() => {
            ...
            if (filteredFavorites.length === 0) {
              return (
                <div className="text-center py-12 sm:py-16 border border-dashed border-border/30 rounded-2xl bg-card/5">
                  ...
                  <h3 className="font-display text-base sm:text-lg font-semibold mb-2 select-none">
                    {searchQuery
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {filteredFavorites.map((favorite: unknown, index: number) => {
                  ...
                  const productCategory =
                    getString(productRecord['category']) || getString(productRecord['type']);

                  const brandsValue = productRecord['brands'];
                  const brandFromBrands = isRecord(brandsValue) ? brandsValue['name'] : undefined;
                  const productBrand =
                    getString(productRecord['brand']) || getString(brandFromBrands);
        ...
        <div className="border-t border-border/20 pt-10 sm:pt-12">
          <div className="flex items-center gap-2 sm:gap-3 mb-6">
