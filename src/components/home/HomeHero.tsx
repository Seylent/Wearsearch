...
export function HomeHero({
  ...
  return (
    <section className="relative min-h-[70svh] sm:min-h-[84svh] md:min-h-[92svh] w-full overflow-hidden md:overflow-visible text-earth">
      <div className="relative z-10 h-full flex flex-col justify-end">
        <div className="max-w-[1800px] mx-auto w-full px-4 sm:px-6 md:px-12 lg:px-16 pt-8 pb-14 sm:pt-12 sm:pb-20 md:pt-14 md:pb-24 mt-16 sm:mt-32 md:mt-48">
          ...
          <p className="text-base md:text-lg text-earth/70 max-w-2xl mt-4 sm:mt-6 mb-6 md:mb-8 font-medium leading-relaxed">
            {contentText ||
              t(
