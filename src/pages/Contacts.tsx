...
const Contacts = () => {
  ...
  useSEO({
    title: t('contacts.seoTitle', 'Contact Us - WearSearch'),
    description: t('contacts.seoDescription', 'Get in touch with WearSearch team. Suggest improvements or add your store to our platform.'),
    keywords: 'contact, support, suggestions, store partnership',
    type: 'website',
  });
