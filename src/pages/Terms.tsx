...
const Terms: React.FC = () => {
  ...
  useSEO({
    title: t('terms.seoTitle', 'Terms of Service - Wearsearch'),
    description: t('terms.seoDescription', 'Terms of service and user agreement for Wearsearch platform'),
    keywords: 'terms, conditions, agreement, legal, privacy',
    type: 'website',
  });
